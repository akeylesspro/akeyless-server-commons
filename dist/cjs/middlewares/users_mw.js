...
exports.dashboard_user_login = exports.installer_login = exports.get_users_login = exports.verify_user_auth = void 0;
...
const installer_login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        /// get user from FB
        const user = yield (0, helpers_1.query_document)("technicians", "phone", "==", (0, helpers_1.convert_to_short_phone_number)(phone_number));
        /// akeyless client is as default
        const default_client_keys = yield (0, helpers_1.get_document_by_id)("nx-settings", "default_client");
        const default_client = yield (0, helpers_1.query_document)("nx-clients", "key", "==", default_client_keys.camera_installation);
...
const dashboard_user_login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const authorization = req.headers.authorization;
        const user_data = yield (0, helpers_1.verify_token)(authorization);
        const { phone_number } = user_data;
        ...
        const user = yield (0, helpers_1.query_document)("nx-users", "phone_number", "==", (0, helpers_1.convert_to_short_phone_number)(phone_number));
        req.body.user = user;
        next();
    }
    catch (error) {
...
exports.dashboard_user_login = dashboard_user_login;
