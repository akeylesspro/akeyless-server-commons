...
export declare const send_local_sms: (phone_number: string, text: string, entity_for_audit: string) => Promise<void>;
export declare const send_sms: (phone_number: string, text: string, entity_for_audit: string) => Promise<void>;
